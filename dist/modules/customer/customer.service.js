...
// ===== PROFILE =====
const getProfile = (userId) => prisma.user.findUnique({ where: { id: userId } });
...
const createOrder = async (userId, items, address, name, phone) => {
...
// ===== REVIEWS =====
const addReview = async (userId, medicineId, rating, comment) => {
